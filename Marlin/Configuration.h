...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  25.95,  25.95 }
    #define DEFAULT_Ki_LIST {   2.51,   2.51 }
    #define DEFAULT_Kd_LIST {  66.96,  66.96 }
  #else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.3, -3.8, 0 }
